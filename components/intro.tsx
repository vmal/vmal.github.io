...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Vaibhav Malhotra.</span> I'm a{" "}
        <span className="font-bold">Senior Software Engineer</span> with{" "}
        <span className="font-bold">6 years</span> of experience. I enjoy
        building <span className="italic">backend infrastructure for web/mobile apps</span>. My expertise is on{" "}
